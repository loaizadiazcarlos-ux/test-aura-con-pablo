# AI bootstrap: Obsidian documentation (test-aura-con-pablo)

You are helping maintain internal documentation for this repository.

## Scope

- Vault root: `wiki/obsidian-aura-con-pablo` (relative to repo root).
- API catalog: Bruno collection `wiki/bruno-aura-con-pablo` — mirror `app/api/**` route handlers.
