...
const buttonVariants = cva("button", {
  variants: {
    variant: {
      ...
      /**
       * Do not compose with `.button-pill` — that CSS forces `color: gray-12`
       * and collapses to ~1:1 on dark sections.
       */
      "pill-dark":
        "border-2 border-gray-8 bg-transparent text-gray-1 hover:bg-gray-11 hover:text-gray-1",
      link: "button-link",
      menu: "button-menu",
    },
    size: {
